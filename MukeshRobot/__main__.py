...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🏡𝐎𝐅𝐅𝐈𝐂𝐄🏡", url=f"https://t.me/MAHTOxOFFICIAL"),
    ],
    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📍𝐎𝐖𝐍𝐄𝐑📍", url=f"https://t.me/QUEENx_GOD"
                        ),
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
                            url="https://github.com/mahtoanjali/ANJALI-VIP-ROBOT",
                        ),
                    ],
                    [
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://te.legra.ph/file/471ef129b9c1b479676fd.jpg",
                caption=f"""
{dispatcher.bot.first_name}

╔═════ஜ۩۞۩ஜ═════╗

  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𓆩 ᴍᴧʜᴛᴏ ✗ ᴧɴᴊᴀʟɪ 𓆪](https://t.me/QUEENx_GOD)♨️
